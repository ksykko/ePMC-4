<section id="home-banner" class="py-4 py-xl-5 " style="background: url('<?= base_url('/assets/img/others/banner-epmcblue.png') ?>') center / cover no-repeat;">
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-md-10 col-lg-12 col-xl-8 col-xxl-12 text-center d-flex d-sm-flex d-md-flex mx-auto justify-content-md-start justify-content-xxl-start align-items-xxl-start">
                <div class="headings">
                    <h1 class="h1-first">Welcome to</h1>
                    <h1 class="h1-second">Pagtakhan Medical Clinic's<br>Website</h1>
                </div>
            </div>
        </div>
    </div>
...
<section id="home">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="h1-third">Pagtakhan Medical Clinic Web and Mobile Application</h1>
                <p>Pagtakhan Medical Clinic now has a web and mobile application where patients can view their doctor’s schedule, patient’s general data, history of consultation, and lab reports. The website also has a chatbot where patient’s can ask about their concerns regarding the clinic.<br><br></p>
            </div>
            <div class="col-md-6"><img class="img-fluid" src=" <?= base_url('/assets/img/others/Home.png') ?> "></div>
        </div>
        <p class="signature ">Copyright © ePMC 2022</a>
        </p>
    </div>
</section>
...
<section id="about">
    <div class="container py-4 py-xl-5 abt-container">
        ...
        <div class="row gy-4 row-cols-1 row-cols-md-4 d-md-flex d-lg-flex d-xxl-flex justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xxl-center" style="margin-bottom: 40px;">
            <div class="col">
        ...
        <div class="row gy-4 row-cols-1 row-cols-md-4 d-lg-flex d-xxl-flex justify-content-lg-center align-items-lg-center justify-content-xxl-center align-items-xxl-center" style="margin-bottom: 40px;position: static;display: none;">
            <div class="col">
                <div class="card border-0 shadow-none">
