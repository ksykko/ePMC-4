<div class="container-fluid patientrec-container">
    <div class="d-flex mb-3">
        <div>
            <h1 class="d-none d-lg-inline-block patientrec-label">Schedule Requests</h1>
        </div>
                    ...
                    <table id="example" class="table table-hover" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-3 align-middle">Schedule</th>
                                <th class="col-md-3 align-middle">Doctor</th>
